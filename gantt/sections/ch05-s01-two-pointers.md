[← Back to Sorting, Two Pointers, and Intervals](../chapters/ch05-sorting-two-pointers-and-intervals.md)

# Two Pointers

Within [Sorting, Two Pointers, and Intervals](../chapters/ch05-sorting-two-pointers-and-intervals.md).

5 problems · 3 groupings · 0/5 implemented · Apr 6, 2026 -> Apr 11, 2026

## Groupings

- Symmetric Scans · 2 problems · Apr 6, 2026 -> Apr 9, 2026
- Sorted Elimination · 2 problems · Apr 6, 2026 -> Apr 11, 2026
- Boundary Optimization · 1 problem · Apr 6, 2026 -> Apr 8, 2026
...
gantt
    ...
    section Symmetric Scans
    125                                :sp01, 2026-04-06, 2d
    392                                :sp02, after sp01, 2d

    section Sorted Elimination
    167                                :crit, sp03, 2026-04-06, 3d
    15                                 :crit, sp04, after sp03, 3d

    section Boundary Optimiza...
    11                                 :sp05, 2026-04-06, 3d

    END · problem map complete        :milestone, crit, mend, after sp02 sp04 sp05, 0d
```

## Coverage

- Implemented in this repo: 0/5
...
- `125` Valid Palindrome · `E` · 2d · planned
- `392` Is Subsequence · `E` · 2d · planned

### Sorted Elimination

2 problems · Apr 6, 2026 -> Apr 11, 2026

- `167` Two Sum II — Sorted · `M` · 3d · planned ★
- `15` 3Sum · `M` · 3d · planned ★

### Boundary Optimization

1 problem · Apr 6, 2026 -> Apr 8, 2026

- `11` Container With Most Water · `M` · 3d · planned
