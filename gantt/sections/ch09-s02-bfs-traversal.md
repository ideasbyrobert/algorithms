...
5 problems · 1 grouping · 0/5 implemented · Apr 6, 2026 -> Apr 19, 2026

## Groupings

- Level Summaries · 5 problems · Apr 6, 2026 -> Apr 19, 2026
...
gantt
    ...
    637                                :sp01, 2026-04-06, 2d
    102                                :sp02, after sp01, 3d
    199                                :sp03, after sp02, 3d
    103                                :sp04, after sp03, 3d
    1161                               :sp05, after sp04, 3d

    END · problem map complete        :milestone, crit, mend, after sp05, 0d
```
...
- `637` Average of Levels · `E` · 2d · planned
- `102` Level Order Traversal · `M` · 3d · planned
- `199` Binary Tree Right Side View · `M` · 3d · planned
- `103` Zigzag Level Order Traversal · `M` · 3d · planned
- `1161` Maximum Level Sum of Binary Tree · `M` · 3d · planned
