[← Back to Stacks, Queues, and Monotonic Structures](../chapters/ch04-stacks-queues-and-monotonic-structures.md)

# Monotonic Stacks — Aggressive Pruning

Within [Stacks, Queues, and Monotonic Structures](../chapters/ch04-stacks-queues-and-monotonic-structures.md).

3 problems · 2 groupings · 0/3 implemented · Apr 6, 2026 -> Apr 11, 2026

## Groupings

- Next-Greater Patterns · 2 problems · Apr 6, 2026 -> Apr 11, 2026
- Basin Computation · 1 problem · Apr 6, 2026 -> Apr 10, 2026
...
gantt
    ...
    section Next-Greater Patt...
    739                                :sp01, 2026-04-06, 3d
    901                                :sp02, after sp01, 3d

    section Basin Computation
    42                                 :crit, sp03, 2026-04-06, 5d

    END · problem map complete        :milestone, crit, mend, after sp02 sp03, 0d
```

## Coverage

- Implemented in this repo: 0/3
...
- `739` Daily Temperatures · `M` · 3d · planned
- `901` Online Stock Span · `M` · 3d · planned

### Basin Computation

1 problem · Apr 6, 2026 -> Apr 10, 2026

- `42` Trapping Rain Water · `H` · 5d · planned ★
