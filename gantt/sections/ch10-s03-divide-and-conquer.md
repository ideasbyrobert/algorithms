[← Back to BST, Tries, and Divide & Conquer](../chapters/ch10-bst-tries-and-divide-and-conquer.md)

# Divide and Conquer

Within [BST, Tries, and Divide & Conquer](../chapters/ch10-bst-tries-and-divide-and-conquer.md).

4 problems · 2 groupings · 0/4 implemented · Apr 6, 2026 -> Apr 13, 2026

## Groupings

- Split & Build · 3 problems · Apr 6, 2026 -> Apr 13, 2026
- Exponentiation · 1 problem · Apr 6, 2026 -> Apr 8, 2026
...
gantt
    ...
    section Split & Build
    108                                :sp01, 2026-04-06, 2d
    148                                :sp02, after sp01, 3d
    427                                :sp03, after sp02, 3d

    section Exponentiation
    50                                 :sp04, 2026-04-06, 3d

    END · problem map complete        :milestone, crit, mend, after sp03 sp04, 0d
```

## Coverage

- Implemented in this repo: 0/4
...
- `108` Convert Sorted Array to BST · `E` · 2d · planned
- `148` Sort List · `M` · 3d · planned
- `427` Construct Quad Tree · `M` · 3d · planned

### Exponentiation

1 problem · Apr 6, 2026 -> Apr 8, 2026

- `50` Pow(x, n) · `M` · 3d · planned
