...
2 problems · 2 groupings · 0/2 implemented · Apr 6, 2026 -> Apr 8, 2026

## Groupings

- Feasibility · 1 problem · Apr 6, 2026 -> Apr 8, 2026
- Ordering · 1 problem · Apr 6, 2026 -> Apr 8, 2026
...
gantt
    ...
    section Feasibility
    207                                :crit, sp01, 2026-04-06, 3d

    section Ordering
    210                                :crit, sp02, 2026-04-06, 3d

    END · problem map complete        :milestone, crit, mend, after sp01 sp02, 0d
```

## Coverage

- Implemented in this repo: 0/2
...
- `207` Course Schedule · `M` · 3d · planned ★

### Ordering

1 problem · Apr 6, 2026 -> Apr 8, 2026

- `210` Course Schedule II · `M` · 3d · planned ★
