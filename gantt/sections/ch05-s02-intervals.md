...
5 problems · 2 groupings · 0/5 implemented · Apr 6, 2026 -> Apr 13, 2026

## Groupings

- Build & Merge · 3 problems · Apr 6, 2026 -> Apr 13, 2026
- Greedy Pruning · 2 problems · Apr 6, 2026 -> Apr 11, 2026
...
gantt
    ...
    section Build & Merge
    228                                :sp01, 2026-04-06, 2d
    56                                 :sp02, after sp01, 3d
    57                                 :sp03, after sp02, 3d

    section Greedy Pruning
    435                                :sp04, 2026-04-06, 3d
    452                                :sp05, after sp04, 3d

    END · problem map complete        :milestone, crit, mend, after sp03 sp05, 0d
```
...
- `228` Summary Ranges · `E` · 2d · planned
- `56` Merge Intervals · `M` · 3d · planned
- `57` Insert Interval · `M` · 3d · planned

### Greedy Pruning

2 problems · Apr 6, 2026 -> Apr 11, 2026

- `435` Non-overlapping Intervals · `M` · 3d · planned
- `452` Minimum Number of Arrows · `M` · 3d · planned
