...
# Chapter 08 — Binary Search — Decision Boundaries

Within [Part II · Boundaries](../README.md).

1 section · 3 groupings · 13 problems · 1/13 implemented · Apr 6, 2026 -> May 11, 2026
...
gantt
    ...
    section The Binary Search Lens
    Binary Search                      :cs01, 2026-04-06, 36d
    END · section map complete        :milestone, crit, mend, after cs01, 0d

    click cs01 href "../sections/ch08-s01-the-binary-search-lens.md"
```
...
[Open problem gantt](../sections/ch08-s01-the-binary-search-lens.md) · 13 problems · 3 groupings · 1/13 implemented · Apr 6, 2026 -> May 11, 2026

Groupings: Template & Answer Space; Structured Arrays; Threshold & Partition
