...
# Chapter 06 — Prefix Sums and Kadane's Algorithm

Within [Part II · Boundaries](../README.md).

1 section · 3 groupings · 6 problems · 0/6 implemented · Apr 6, 2026 -> Apr 23, 2026
...
gantt
    ...
    section The Prefix Lens
    Prefix Lens                        :crit, cs01, 2026-04-06, 18d
    END · section map complete        :milestone, crit, mend, after cs01, 0d

    click cs01 href "../sections/ch06-s01-the-prefix-lens.md"
```
...
[Open problem gantt](../sections/ch06-s01-the-prefix-lens.md) · 6 problems · 3 groupings · 0/6 implemented · Apr 6, 2026 -> Apr 23, 2026

Groupings: Running Aggregates; Max-Subarray Variants; Boundary Accumulation
