...
# Chapter 11 — Dynamic Programming I — Memoization

Within [Part III · Decomposition](../README.md).

1 section · 3 groupings · 8 problems · 0/8 implemented · Apr 6, 2026 -> Apr 26, 2026
...
gantt
    ...
    section The Memoization Lens
    Memo Lens                          :cs01, 2026-04-06, 21d
    END · section map complete        :milestone, crit, mend, after cs01, 0d

    click cs01 href "../sections/ch11-s01-the-memoization-lens.md"
```
...
[Open problem gantt](../sections/ch11-s01-the-memoization-lens.md) · 8 problems · 3 groupings · 0/8 implemented · Apr 6, 2026 -> Apr 26, 2026

Groupings: Fibonacci Family; Choice Recurrences; Sequence & Decomposition
