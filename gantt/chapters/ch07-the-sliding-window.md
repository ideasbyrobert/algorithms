...
# Chapter 07 — The Sliding Window

Within [Part II · Boundaries](../README.md).

1 section · 3 groupings · 9 problems · 0/9 implemented · Apr 6, 2026 -> May 4, 2026
...
gantt
    ...
    section The Window Lens
    Window Lens                        :crit, cs01, 2026-04-06, 29d
    END · section map complete        :milestone, crit, mend, after cs01, 0d

    click cs01 href "../sections/ch07-s01-the-window-lens.md"
```
...
[Open problem gantt](../sections/ch07-s01-the-window-lens.md) · 9 problems · 3 groupings · 0/9 implemented · Apr 6, 2026 -> May 4, 2026

Groupings: Fixed Windows; Variable Windows; Implicit Windows
