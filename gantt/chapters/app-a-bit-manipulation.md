...
# APPENDIX A: BIT MANIPULATION

Within [Appendices](../README.md).

1 section · 2 groupings · 8 problems · 0/8 implemented · Apr 6, 2026 -> Apr 24, 2026
...
gantt
    ...
    section Sections
    Bit Manip                          :cs01, 2026-04-06, 19d
    END · section map complete        :milestone, crit, mend, after cs01, 0d

    click cs01 href "../sections/app-a-s01-bit-manipulation-problems.md"
```
...
[Open problem gantt](../sections/app-a-s01-bit-manipulation-problems.md) · 8 problems · 2 groupings · 0/8 implemented · Apr 6, 2026 -> Apr 24, 2026

Groupings: XOR & Counting; Bit-State Reconstruction
