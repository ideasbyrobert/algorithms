...
# Chapter 09 — Recursion and Binary Trees

Within [Part III · Decomposition](../README.md).

2 sections · 4 groupings · 26 problems · 0/26 implemented · Apr 6, 2026 -> Jun 13, 2026
...
gantt
    ...
    section The Recursive Lens
    Recursive                          :cs01, 2026-04-06, 55d
    BFS                                :cs02, 2026-04-06, 14d
    END · section map complete        :milestone, crit, mend, after cs01 cs02, 0d

    click cs01 href "../sections/ch09-s01-recursive-structure.md"
    click cs02 href "../sections/ch09-s02-bfs-traversal.md"
```
...
[Open problem gantt](../sections/ch09-s01-recursive-structure.md) · 21 problems · 3 groupings · 0/21 implemented · Apr 6, 2026 -> May 30, 2026

Groupings: Core Recursion; Path Propagation; Rewire & Rebuild

### BFS Traversal

[Open problem gantt](../sections/ch09-s02-bfs-traversal.md) · 5 problems · 1 grouping · 0/5 implemented · Apr 6, 2026 -> Apr 19, 2026

Groupings: Level Summaries
