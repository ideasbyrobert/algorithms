...
# Chapter 12 — Dynamic Programming II — Tabulation and State Machines

Within [Part III · Decomposition](../README.md).

2 sections · 5 groupings · 12 problems · 0/12 implemented · Apr 6, 2026 -> May 15, 2026
...
gantt
    ...
    section The Tabulation Lens
    Multi-D DP                         :cs01, 2026-04-06, 27d
    State DP                           :crit, cs02, 2026-04-06, 13d
    END · section map complete        :milestone, crit, mend, after cs01 cs02, 0d

    click cs01 href "../sections/ch12-s01-multi-dimensional-dp.md"
    click cs02 href "../sections/ch12-s02-state-machine-dp.md"
```
...
[Open problem gantt](../sections/ch12-s01-multi-dimensional-dp.md) · 9 problems · 3 groupings · 0/9 implemented · Apr 6, 2026 -> May 2, 2026

Groupings: Grid Walks; String Alignment; Shape/Palindrome State

### State Machine DP

[Open problem gantt](../sections/ch12-s02-state-machine-dp.md) · 3 problems · 2 groupings · 0/3 implemented · Apr 6, 2026 -> Apr 18, 2026

Groupings: Transaction Fee; Bounded Transactions
