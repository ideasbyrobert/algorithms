...
# Chapter 05 — Sorting, Two Pointers, and Intervals

Within [Part I · Foundations](../README.md).

2 sections · 5 groupings · 10 problems · 0/10 implemented · Apr 6, 2026 -> May 2, 2026
...
gantt
    ...
    section The Sorted Lens
    Two Pointers                       :crit, cs01, 2026-04-06, 13d
    Intervals                          :cs02, 2026-04-06, 14d
    END · section map complete        :milestone, crit, mend, after cs01 cs02, 0d

    click cs01 href "../sections/ch05-s01-two-pointers.md"
    click cs02 href "../sections/ch05-s02-intervals.md"
```
...
[Open problem gantt](../sections/ch05-s01-two-pointers.md) · 5 problems · 3 groupings · 0/5 implemented · Apr 6, 2026 -> Apr 18, 2026

Groupings: Symmetric Scans; Sorted Elimination; Boundary Optimization

### Intervals

[Open problem gantt](../sections/ch05-s02-intervals.md) · 5 problems · 2 groupings · 0/5 implemented · Apr 6, 2026 -> Apr 19, 2026

Groupings: Build & Merge; Greedy Pruning
