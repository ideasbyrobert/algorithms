...
# Chapter 02 — Linked Lists — Pointer Mechanics

Within [Part I · Foundations](../README.md).

1 section · 3 groupings · 16 problems · 1/16 implemented · Apr 6, 2026 -> May 22, 2026
...
gantt
    ...
    section Pointer Fluency
    Pointer Fluency                    :cs01, 2026-04-06, 47d
    END · section map complete        :milestone, crit, mend, after cs01, 0d

    click cs01 href "../sections/ch02-s01-pointer-fluency.md"
```
...
[Open problem gantt](../sections/ch02-s01-pointer-fluency.md) · 16 problems · 3 groupings · 1/16 implemented · Apr 6, 2026 -> May 22, 2026

Groupings: Core Pointer Rewrites; Number Construction; Structure & Systems
